          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div>
              <div className="flex justify-center text-teal-600 sm:justify-start">
                <img
                  className="w-32 h-32 sm:h-24"
                  src="https://res.cloudinary.com/dcpte972l/image/upload/v1690889559/Logo-01_ktb1hw.png"
                  alt=""
                />
              </div>
              ...
              <ul className="mt-5 flex justify-center gap-6 sm:justify-start md:gap-8">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-pink-600 transition hover:text-pink-700/75"
                  >
